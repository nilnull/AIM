...
namespace AegisImplicitMail
{
    ...
    interface IMailer
    {
        ...
        AbstractMailMessage GenerateMail(List<IMailAddress> toAddresses, List<IMailAddress> ccAddresses, List<IMailAddress> bccAddresses, List<string> attachmentsList, string subject, string body);
        /// <summary>
        /// Send an email
        /// </summary>
